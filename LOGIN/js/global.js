...
if (botonlogin) {
  if (usuario) {
    botonlogin.innerText = usuario;
  } else {
    botonlogin.innerText = "Inicio de sesion";
  }

  // escuchador
  document.querySelector("#Login").addEventListener("click", sesion);
}

// // funcion de icicio de sesion
// function sesion() {
